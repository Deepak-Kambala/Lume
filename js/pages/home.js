  // Simple animations and interactions
        document.addEventListener('DOMContentLoaded', function() {
            ...
            createGroup.addEventListener('click', function() {
                alert('Group creation feature coming soon! You will be able to create custom research communities with inbuilt video calling for collaboration.');
            });
            ...
            viewAll.addEventListener('click', function(e) {
                e.preventDefault();
                alert('This will show all available research opportunities from universities that have partnered with our platform.');
            });
        });